  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<MovieDetailsViewModel, MovieDetailsStates>(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            //todo: Movie name
                            Text(state.movieName, style: AppStyles.bold16White),
                          ],
                        ),
                      ),
                    ),
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              return CustomCastContainer(
                                imagePath:
                                    state.cast[index].urlSmallImage ?? '',
          ...
          return Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: Text('Try Again', style: AppStyles.medium16yellow),
              ),
            ],
          );
        }
      ...
      listener: (context, state) {
        /*if(state is SuccessState && state.isFavorite == true){
