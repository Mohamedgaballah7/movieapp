                            ...
                            child: PageView.builder(
                              ...
                              itemBuilder: (context, index) {
                                if (index == currentPage) {
                                  return Image.asset(
                                    avatars[index], scale: 0.09,);
                                } else {
                                  return Image.asset(
                                      avatars[index], scale: 1.2);
                                }
                              },
                            ),
                          ),
  ...
  void register() {
    if(formKey.currentState?.validate()==true){
      ...
      viewModel.register(
          ...
          confirmPasswordController.text, phoneController.text, currentPage);
    }
  }
}
