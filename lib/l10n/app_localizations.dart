...
abstract class AppLocalizations {
  ...
  /// No description provided for @find_your_next_favorite.
  ///
  /// In en, this message translates to:
  /// **'Find Your Next Favorite Movie Here'**
  String get find_your_next_favorite;

  /// No description provided for @get_access_library.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @discover_movies_genre.
  ///
  /// In en, this message translates to:
  /// **'Discover movies from every genre, in all available qualities. Find something new and exciting to watch every day.'**
  String get discover_movies_genre;

  /// No description provided for @create_watch_lists.
  ///
  /// In en, this message translates to:
  /// **'Create WatchLists'**
